...
const Home = () => {
  return (
    <div className='mx-auto px-4 bg-black text-white w-full h-[100vh] flex flex-col md:flex-row md:justify-center md:items-center'>
      {/* Desktop view */}
      <div className='hidden md:flex md:flex-row md:justify-center md:items-center md:w-full'>
        <div className='md:w-1/2 md:ml-[50px] lg:ml-[100px]'>
          <h1 className='font-archivo text-[30px] md:text-[45px]'>
